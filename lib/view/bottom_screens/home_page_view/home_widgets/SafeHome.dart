...
class _SafeHomeState extends State<SafeHome> {
  ...
  //     });
  //     print(_curentPosition.toString());
  //     Fluttertoast.showToast(msg: _curentPosition.toString());
  //   }).catchError((e) {
        ...
        child: Container(
          ...
          child: Row(children: [
            const Expanded(
              ...
              ListTile(title: Text("Send Location"), subtitle: Text("Share Location")),
            ])),
            ClipRRect(borderRadius: BorderRadius.circular(20), child: Image.asset('Assets/images/icons/route.jpg')),
          ]),
        ),
      ),
    );
