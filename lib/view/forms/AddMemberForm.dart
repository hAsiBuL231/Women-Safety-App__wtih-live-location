...
import '../../view_models/forms_view_models/AddMember_Form_VM.dart';
...
class _AddMemberFormState extends State<AddMemberForm> {
  AddMemberFormVM addMemberFormVM = Get.put(AddMemberFormVM());
                          ...
                          Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Form(
                                    key: addMemberFormVM.addMemberFormKey,
                                    autovalidateMode: AutovalidateMode.always,
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(0, 8, 0, 0),
                                      child: TextFormField(
                                        // onTap: () {},
                                        controller: addMemberFormVM.securityCodeController.value,
                                    ...
                                    child: Row(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.end, children: [
                                      Padding(
                                        ...
                                        child: FloatingActionButton.extended(
                                            onPressed: () async {
                                              addMemberFormVM.submitForm(widget.passedGroup, context);
